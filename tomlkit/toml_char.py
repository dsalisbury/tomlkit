...
class TOMLChar(str):
    def __init__(self, c):
        ...
        self.is_kv_sep = (self._is_kv_sep)
        self.is_int_float_char = (self._is_int_float_char)
        self.is_ws = (self._is_ws)
        self.is_nl = (self._is_nl)
        self.is_spaces = (self._is_spaces)
        super().__init__()
